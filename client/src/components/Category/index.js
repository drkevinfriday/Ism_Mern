...
const Category = (props) => {
  ...
  let [photos] = useState([
    ...
    },
    {
      ...
      url: "/category/sexism",
      description:
        "Sexism is form of discrimination on the basis of sex. Women are more likely to experience sexism as well as other marginalized genders. Sexism encourages a hostile environment which not only affects women in the workplace but also perceived gender roles that are perpetuated in society.",
    },
    ...
    },
    {
      ...
      description:
        "Colorism is prejudice against people with a darker skin tone and is characterized by its occurrence within the same ethnic or racial community.",
    },
    {
      id: 7,
      name: "Cissexism",
    ...
    },
    {
      ...
      description:
        "Elitism exists in the form of a patriarchal system in which the highest status is assigned to the most privileged. Elitism is a form of discrimination on the basis of social standing.",
    },
  ]);
            ...
            <Col key={id}>
              <Card>
                ...
                >
                  <a
                    variant="primary"
                    onClick={handleShow} //onClick={handleShow}//onClick={() => Description()} // to={url}
                    style={{
                      textDecoration: "none",
                      fontFamily: "Misto",
                      fontSize: "2.7vw",
